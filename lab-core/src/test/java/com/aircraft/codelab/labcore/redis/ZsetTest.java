...
//        redisTemplate.opsForZSet().add("ranking-list", new HashSet<>(Arrays.asList(tuple1, tuple2)));
    ...
    public void test6() {
        ...
        Set<String> ranking = redisTemplate.opsForZSet().rangeByScore("ranking-list", 0, 3);
        ...
        long currentPage = 2;
        long pageSize = 2;
        Set<String> ranking3 = redisTemplate.opsForZSet()
                .rangeByScore("ranking-list", 0, 5, (currentPage - 1) * pageSize, pageSize);
