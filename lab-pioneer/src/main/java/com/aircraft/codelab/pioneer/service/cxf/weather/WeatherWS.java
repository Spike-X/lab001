 ...
 * 2023-12-10T21:50:50.035+08:00
 * Generated source version: 3.5.7
 *
 */
@WebServiceClient(name = "WeatherWS",
                  wsdlLocation = "file:/D:/workspace/cxf/webxml.com.cn_WebServices_WeatherWS.asmx_wsdl.xml",
...
public class WeatherWS extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/workspace/cxf/webxml.com.cn_WebServices_WeatherWS.asmx_wsdl.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherWS.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/workspace/cxf/webxml.com.cn_WebServices_WeatherWS.asmx_wsdl.xml");
        }
        WSDL_LOCATION = url;
    }
